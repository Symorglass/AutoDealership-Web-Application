...
CREATE USER IF NOT EXISTS adminUser@localhost IDENTIFIED BY 'password123456';

DROP DATABASE IF EXISTS `AutoDealerDB`;
SET default_storage_engine=InnoDB;
SET NAMES utf8mb4 COLLATE utf8mb4_unicode_ci;

CREATE
DATABASE IF NOT EXISTS AutoDealerDB
...
ON *.* TO 'adminUser'@'localhost';
GRANT ALL PRIVILEGES ON `adminUser`.* TO 'adminUser'@'localhost';
GRANT ALL PRIVILEGES ON `AutoDealerDB`.* TO 'adminUser'@'localhost';
FLUSH PRIVILEGES;
...
(
    VIN                  CHAR(20) NOT NULL,
    drivetrain_type      CHAR(20) NOT NULL,
...
ALTER TABLE Vehicle
   ...
   ADD CONSTRAINT fk_Vehicle_manufacturer_Manufacturer_manufacturer FOREIGN KEY ( manufacturer ) REFERENCES Manufacturer ( manufacturer ) ON UPDATE CASCADE;
