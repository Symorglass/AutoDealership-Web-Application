        ...
        <div class="center_left">
            ...
            <div class="features">
                ...
                <div class="profile_section">
                    ...
                    <form name="individualform" action="add_customer_for_repair.php" method="post">
                        <table>
                            <tr>
                    ...
                    <form name="businessform" action="add_customer_for_repair.php" method="post">
                        <table>
                            <tr>
                        ...
                        <table>
                            <tr>
                                <td class="item_label"><br><br>Back to add repair form</td>
                            </tr>
                            <tr>
                                <td><a href="add_repair.php" class="fancy_button">Back</a></td>
                            </tr>
                        </table>
